describe('Chrome Content Script', function suite() {
    ...
    it('should demand authorDetails', function (done) {
        ...
        //try {
        //    //jQuery("span.CahootsID_c29bca5141c539897b9fb19fc071dd12475e86aa.tooltipstered").trigger(mouseoverEvent);
        //} catch(e) {
        //    console.log(e)
        //}
        ...
        setTimeout(function () {
            //jQuery("span.CahootsID_c29bca5141c539897b9fb19fc071dd12475e86aa.tooltipstered").onmouseover()
    ...
    it('should display cahoots popover', function (done) {
        // ensure element does not exist beforehand
        ...
        //console.log(popoverObservedHtml)
